...
<body style="background-color: #12212f;font-family:poppins;">
    ...
    <div class="title d-flex justify-content-between mt-4 ms-5">
        <h2 class="p-2 g-3" style="color: #e1e1e1; display: inline-block; margin-bottom:26px;">CIE A-Level Mathematics</h2>
    ...
    <div class="content d-md-inline-flex align-items-center">
        <div class="content1" style="color:#e1e1e1; margin-left:50px;">
            ...
            <div class="row mt-4">
                <div class="col-11">
                    <button class="btn" style="margin-right: 15px; margin-bottom: 15px;"><a href="https://youtu.be/hCuYAoditNA?list=PLS-TIpNmaiIANuyKQ_iuu4nH14ft5RK7e" class="p-2" style="text-decoration: none;" target="_blank">Chapter 1</a></button>
                    <button class="btn" style="margin-right: 15px; margin-bottom: 15px;"><a href="https://youtu.be/-g8Hcfbap1Y?list=PLS-TIpNmaiIANuyKQ_iuu4nH14ft5RK7e" class="p-2" style="text-decoration: none;" target="_blank">Chapter 2</a></button>
                    <button class="btn" style="margin-right: 15px; margin-bottom: 15px;"><a href="https://youtu.be/rWnYkrKmawg?list=PLS-TIpNmaiIANuyKQ_iuu4nH14ft5RK7e" class="p-2" style="text-decoration: none;" target="_blank">Chapter 3</a></button>
                    <button class="btn" style="margin-right: 15px; margin-bottom: 15px;"><a href="https://youtu.be/TQqsGYWZDT8?list=PLS-TIpNmaiIANuyKQ_iuu4nH14ft5RK7e" class="p-2" style="text-decoration: none;" target="_blank">Chapter 4</a></button>
                    <button class="btn" style="margin-right: 15px; margin-bottom: 15px;"><a href="https://youtu.be/Nvsf4Z7PHGA?list=PLS-TIpNmaiIANuyKQ_iuu4nH14ft5RK7e" class="p-2" style="text-decoration: none;" target="_blank">Chapter 5</a></button>
                    <button class="btn" style="margin-right: 15px; margin-bottom: 15px;"><a href="https://youtu.be/xFN3pkL22_Y?list=PLS-TIpNmaiIANuyKQ_iuu4nH14ft5RK7e" class="p-2" style="text-decoration: none;" target="_blank">Chapter 6</a></button>
                    <button class="btn" style="margin-right: 15px; margin-bottom: 15px;"><a href="https://youtu.be/xgd8fMO-OtQ?list=PLS-TIpNmaiIANuyKQ_iuu4nH14ft5RK7e" class="p-2" style="text-decoration: none;" target="_blank">Chapter 7</a></button>
                    <button class="btn" style="margin-right: 15px; margin-bottom: 15px;"><a href="https://youtu.be/6Wq-bl22gDk?list=PLS-TIpNmaiIANuyKQ_iuu4nH14ft5RK7e" class="p-2" style="text-decoration: none;" target="_blank">Chapter 8</a></button>
                    <button class="btn" style="margin-right: 15px; margin-bottom: 15px;"><a href="https://youtu.be/O3RrQ0e4yZs?list=PLS-TIpNmaiIANuyKQ_iuu4nH14ft5RK7e" class="p-2" style="text-decoration: none;" target="_blank">Chapter 9</a></button>
                    <button class="btn" style="margin-right: 15px; margin-bottom: 15px;"><a href="https://youtu.be/zCAmNRmIzrc?list=PLS-TIpNmaiIANuyKQ_iuu4nH14ft5RK7e" class="p-2" style="text-decoration: none;" target="_blank">Chapter 10</a></button>
                </div>
            </div>
        </div>
        <div class="content2">
            ...
            <div class="about-course ms-2 me-2 mb-2" style="padding: 30px;color:#252525;background-color: #00d989; margin-top: 60px; border-radius:8px; opacity:80%;font-size: 18px; word-wrap: break-word;">
                This playlist covers all the chapters that needs to be covered to ace your CIE Add Maths exam. Our teachers have designed the course contents in such a way so that it is easy for the students to grasp the concept and learn maths in a fun way! So why wait? Excel in your IGCSE exam for just<p><h4>BDT999!</h4></p>
            </div>
        </div>
    </div>
