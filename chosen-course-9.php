...
<div class="header">
    ...
    <div class="title d-flex justify-content-between mt-4 ms-5">
      <h2 class="p-2 g-3" style=" margin-left:15px;color: #e1e1e1; display: inline-block; margin-bottom:26px;">CAIE AS Commerce U2</h2>
    ...
    <div class="content d-md-inline-flex justify-content-around align-items-center">
        ...
        <div class="content2">
            ...
            This playlist covers all the chapters that needs to be covered to ace your AS Commerce U2. Our teachers have designed the course contents in such a way so that it is easy for the students to grasp the concept and learn commerce in a fun way! So why wait? Excel in your A2 exam for just<p><h4>BDT899</h4></p>
            </div>
        </div>
    </div>
