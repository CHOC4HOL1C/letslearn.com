...
<body>
  <div class="navbar-div">
    <span class="logo"><a href="index.php">Let's<br /><span class="logo-style">Learn</span></a></span>
  ...
  <div class="card-row" style="height: auto; ">
    <div class="card-item">
      <div class="card-item-text admin-stat-text">
        <h2>8</h2>
        <h5>Courses</h5>
      </div>
    </div>
    ...
    <div class="card-item">
      <div class="card-item-text admin-stat-text">
        <h2><span class="logo-style">+</span>5%</h2>
        <h5>Engagement</h5>
      </div>
    </div>
  </div>
  ...
  <div class="subheading">
    <div style="display: flex; justify-content: center;">
      ...
      <div>
        ...
        $result = mysqli_query($con, "SELECT COUNT(*) as total FROM `courserequest`");
        $row = mysqli_fetch_assoc($result);
        $totalRows = $row['total'];
        echo "<a href='checkRequest.php' target='_blank'><button class='stats-button' style='width: 45px; height: 45px; border-radius: 50%; position: absolute; left: 500px; bottom: 115px; font-size: 20px'><span id='rowCount'>" . $totalRows . "</span></button></a>";
        mysqli_close($con);
        ?>
      </div>
    </div>
