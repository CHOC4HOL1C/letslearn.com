    ...
    `<div class="card mb-3" style="max-width: 100vw; background: #2a4d6d; color: black;">
      <div class="row g-0 parent">
        <div class="col-8 child1">
            <iframe width="100%" height="623" src="https://www.youtube.com/embed/v-W2CITTiLk?list=PLLapq77LF3oi8onPPQbBz0C_MusUeZPtL" title="Guided Solution 9709 Pure Mathematics 3 May June 2019 Paper 33" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
