          ...
          <div class="sign-up-sign-up-page">
            <div class="sign-up-signup-tray">
              <div class="sign-up-rectangle1">
                ...
                <span class="sign-up-text"><span><a href="LoginPage.html">Login</a></span></span>
                <span class="sign-up-text02"><span>FIRST NAME</span></span>
                <span class="sign-up-text04"><span><a href="SignUp.html">Sign Up</a></span></span>
                <div class="sign-up-rectangle2">
                 <input class = "form-input" type="text" placeholder="Enter First Name">
                </div>
                <span class="sign-up-text06"><span>LAST NAME</span></span>
                <div class="sign-up-rectangle5">
                 <input class = "form-input" type="text" placeholder="Enter Last Name">
                </div>
                ...
                <span class="sign-up-text16"><span><a href="#">Sign Up</a></span></span>
              </div>
